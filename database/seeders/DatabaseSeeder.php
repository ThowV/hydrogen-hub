...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $u_3 = User::create(['email' => "martijnjongman9@gmail.com", "password" => Hash::make('martijn123'), "company_id" => rand(1,2), "first_name" => "Martijn", "last_name" => "Jongman"]);
        $u_4 = User::create(['email' => "h.zwetsloot@groningen-seaports.com", "password" => Hash::make('Henk123!@#'), "company_id" => rand(1,2), "first_name" => "Henk", "last_name" => "Zwetsloot"]);
        $u_5 = User::create(['email' => "rdewolf300@gmail.com", "password" => Hash::make('Rob123!@#'), "company_id" => rand(1,2), "first_name" => "Rob", "last_name" => "de Wolf"]);
