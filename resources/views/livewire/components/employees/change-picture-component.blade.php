<div class="flex flex-col justify-center items-center">
    ...
    <form class="flex flex-col text-center gap-20" wire:submit.prevent="save">
        ...
        <button class="col-start-1 col-span-4 m-auto row-start-6 bg-hovBlue text-white px-6 py-1 rounded sm:text-xxs md:text-xxs lg:text-xxs xl:text-xs xxl:text:lg hover:bg-nav transaction duration-300" type="submit">Save</button>
    </form>
