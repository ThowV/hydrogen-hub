<div class="grid grid-cols-4 grid-row-3 justify-center bg-white w-full h-full overflow-hidden">
    ...
    <div class="relative col-start-1 w-3/4 h-full row-span-3 transition duration-500 ease-in-out transform origin-left hover:scale-150 hover:text-red">
        ...
        <div class="absolute inset-0 bg-auto bg-center" style="background-image: url(https://media-exp1.licdn.com/dms/image/C561BAQHxE9SHfKz_6g/company-background_10000/0?e=2159024400&v=beta&t=XlVltuksEsDRsDWMCskgcScmTKixqgUePDTBuqqbEYE)"></div>
    ...
    <form class="col-start-3 row-start-2 flex flex-col justify-center px-24 sm:px-1 md:px-1 text-nav" wire:submit.prevent="submit">
        ...
        <div class="mb-1">
            <input class="border-b-2 w-full py-2 font-bold xxl:text-2xl placeholder-nav hover:border-nav focus:border-nav transition duration-200" wire:model="password" id="password" type="password" placeholder="******************">
        ...
        <div class="flex justify-end">
            <a class="inline-block font-bold text-sm sm:text-xxs xxl:text-xl  text-gray-600 hover:text-blue-800 underline" href="#">
                Forgot password?
            </a>
        </div>
        <div class="flex justify-center">
            <button class="bg-nav hover:bg-hovBlue text-white text-xs xxl:text-2xl  py-2 px-8 rounded-lg focus:outline-none focus:shadow-outline mt-12 transition duration-200 ease-in-out" type="submit">
                Login
            </button>
        </div>
    </form>
