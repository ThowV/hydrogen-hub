                    ...
                    @foreach($trades as $trade)
                        <tr class="w-full flex flex-row py-8 md:py-5 xxl:py-12 items-center text-sm sm:text-xs xl:text-base xxl:text-3xl border-gray-200">
                            ...
                            <td class="flex items-center w-full">
                                ...
                                @else
                                <button
                                    class="bg-gray-100 hover:bg-gray-500 border-2 border-gray-500 text-gray hover:text-white text-xs sm:text-xxs xxl:text-2xl py-1 px-8 sm:py-1 sm:px-3 rounded-lg transition duration-300 ease-in-out"
                                    wire:click="openListing({{ $trade }})">
                                    Own
                                </button>
                                @endif
