<div class="z-40 w-full h-full text-gray-700">
    @if($isOpen)
        <div class="modal fixed top-0 h-full w-full grid grid-cols-8 grid-rows-6">
            ...
            <div class="modal-container max-h-full max-w-full grid col-start-1 row-start-2 col-span-7 sm:col-span-6 mx-10 xxl:mx-20 row-span-4 bg-white rounded shadow-lg z-50 ">
                ...
                <div class="modal-content flex flex-col w-full h-full p-8 text-left ">
                    <!--Title-->
                    <div class="flex justify-between items-center pb-5">
                        <p class="text-2xl xxl:text-4xl font-bold">{{ $trade["trade_type"] === "offer" ? "Buy" : "Sell" }}</p>
                    ...
                    <div class="flex justify-center font-bold pb-12 text-xl xxl:text-2xl">Overview</div>

                    <!--Body-->
                    <div class="h-full w-full grid grid-cols-7 grid-rows-3">

                        <div class="graph h-full row-span-3 col-span-3 px-20 sm:px-2 md:px-10 xxl:px-40 pb-20 sm:pb-5 md:pb-10 xxl:pb-40 items-start">
                            <img class="object-scale-down w-full h-full" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fi.stack.imgur.com%2FveUID.png&f=1&nofb=1" alt="placeholder">
                        </div>
                        ...
                        <t/><p class="text-base sm:text-xs xxl:text-2xl">
                            <b>Expires in:</b>
