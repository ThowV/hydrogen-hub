<div class="flex flex-col h-full">
    <div class="flex flex-none w-full justify-between">
        <h2 class="xxl:text-3xl font-bold">Employees</h2>
        ...
        @foreach($employees as $employee)
            <tr class="flex flex-col text-center">
                ...
                <td class="pt-4 xxl:pt-8">
                    <a wire:click="toggleModal({{$employee->id}})" class="rounded-lg px-4 py-1 bg-blue-100 border-2 border-hovBlue hover:bg-hovBlue text-hovBlue hover:text-white text-xxs sm:text-xxs xxl:text-2xl transition duration-200 ease-in-out">
                        <button>View</button>
                    </a>
                </td>
                <td>
