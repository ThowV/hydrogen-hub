<div class="grid grid-cols-4 grid-row-3 justify-center bg-white w-full h-screen overflow-hidden">
    ...
    <form class="col-start-3 row-start-2 flex flex-col justify-center px-20 sm:px-1 md:px-1 text-nav" wire:submit.prevent="submit">
        ...
        <div class="mb-12">
            <input class="border-b-2 w-full py-2 font-bold xxl:text-2xl placeholder-nav hover:border-nav focus:border-nav transition duration-200"
                   wire:model="company_backup_email" id="inline-last-name" type="text" placeholder="Company Backup E-mail">
            @error('company_backup_email') <span class="error text-red-500">{{ $message }}</span> @enderror
        </div>

        <div class="mb-12">
            <input class="border-b-2 w-full py-2 font-bold xxl:text-2xl placeholder-nav hover:border-nav focus:border-nav transition duration-200"
                   wire:model="company_phone_number" id="inline-last-name" type="text" placeholder="Company Phone Number">
            @error('company_phone_number') <span class="error text-red-500">{{ $message }}</span> @enderror
        </div>
    ...
    <div class="col-start-3 row-start-3 grid justify-center items-end">
        <a href="/" class="text-gray-600 underline font-bold text-sm sm:text-xxs xxl:text-xl  pb-4 cursor-pointer hover:text-blue-800 duration-200">
