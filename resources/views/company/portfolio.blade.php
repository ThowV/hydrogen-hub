...
@section('content')
    <div class="flex w-full h-full flex-col">
        ...
        <!--Header-->
        <div class="flex-auto h-24 grid grid-col-2 grid-rows-2">
        ...
        <div class="flex-auto w-full h-full px-10 xxl:px-20 pb-10 xxl:pb-20 xxl:pt-10">
            <div class="flex flex-row flex-nowrap w-full h-full sm:flex-col">
                <div class="rounded-lg p-10 pb-5 mr-2 w-3/6 sm:w-full sm:mr-0 bg-white text-gray-700">
                    @livewire('components.company.trades-and-listings-component', ['componentType' => 'trades'])
                </div>

                <div class="rounded-lg p-10 pb-5 mr-2 ml-3 w-2/6 sm:w-full sm:ml-0 sm:mt-4 bg-white text-gray-700">
