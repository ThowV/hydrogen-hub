    ...
    <div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
        <nav>
            <ul class="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400 {{ Request::is('/') ? 'bg-indigo-100' : '' }}" href="/">Dashboard</a></li>
                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400 {{ Request::is('market') ? 'bg-indigo-100' : '' }}" href="/market">Market</a></li>
                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400 {{ Request::is('company/') ? 'bg-indigo-100' : '' }}" href="/">Company Portfolio</a></li>
                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400 lg:mb-0 mb-2 {{ Request::is('company/overview') ? 'bg-indigo-100' : '' }}" href="/">Company Overview</a></li>
            </ul>
        </nav>
