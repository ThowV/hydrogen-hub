...
<header>
    ...
    <div class="relative h-screen bg-nav grid grid-rows-6 ">
        ...
        <div class="grid justify-items-center items-center text-white font-black sm:text-sm md:text-xl lg:text-xl xl:text-3xl xxl:text-4xl">HydroActive</div>
        ...
        <nav class="row-start-2 grid justify-items-center items-center sm:text-sm md:text-sm lg:text-sm xl:text-xl xxl:text-3xl" >
            <ul class="text-white font-bold">
                ...
                <li class="grid grid-cols-8 items-center sm:px-8 md:px-8 lg:px-12 xl:px-16 xxl:px-16 sm:pb-8 md:pb-8 lg:pb-10 xl:pb-12 xxl:pb-20 opacity-25 hover:opacity-100 duration-300 cursor-pointer   {{ Request::is('/') ? 'opacity-100' : '' }}" href="/"">
                ...
                <li class="grid grid-cols-8 items-center sm:px-8 md:px-8 lg:px-12 xl:px-16 xxl:px-16 sm:pb-8 md:pb-8 lg:pb-10 xl:pb-12 xxl:pb-20 opacity-25 hover:opacity-100 duration-300 cursor-pointer   {{ Request::is('market') ? 'opacity-100' : '' }}" href="/market">
